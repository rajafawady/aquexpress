<x-customer-layout active="profile">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="profileEditForm">
                        ...
                        <button type="button" style="background-color: #352f44;" class="btn text-white  " onclick="updateProfile()">Save Changes</button>
                    </form>
                </div>
    ...
    <script>
        ...
        // Example: handle image upload using JavaScript
